...
function downloadInstallerOnly(e) {
    ...
    a.href = primaryURL;
    a.download = 'Estimatic_OnlineInstaller.exe';
...
(function () {
    ...
    if (emailBtn) emailBtn.addEventListener('click', () => {
        window.location.href = 'mailto:info@estimatic.store?subject=HEWP%20Excel%20Addins%20Support&body=Hello%20MRGARGSIR%20Team,%0D%0A%0D%0AI%20need%20help%20with...';
    });
    if (whatsappBtn) whatsappBtn.addEventListener('click', () => {
        window.open('https://wa.me/919728532828?text=' + encodeURIComponent("Hello MRGARGSIR Team, I need help with Estimatic Tool."), '_blank');
    });
})();
...
function startDownload(button) {
    ...
    if (button.id === 'downloadBtnStandalone') {
        downloadURL = standaloneURL; secondURL = fallbackURL; installerName = 'Estimatic_OfflineInstaller.exe';
    } else {
        downloadURL = primaryURL; secondURL = fallbackURL; installerName = 'Estimatic_OnlineInstaller.exe';
    }
        ...
        <div class="ticker-bar ticker-bar-global" style="flex-basis:100%; order:2; width:100%;">
            <div class="ticker-wrap">
                <div class="ticker-track">
                    <span class="ticker-item">🚀 Estimatic Tool • BOQ • Estimate • Variation • MB</span>
